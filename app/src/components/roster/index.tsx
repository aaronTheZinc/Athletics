    ...
    <div ref={containerRef} className="roster-container">
      ...
      <div className="p-8 overflow-y-scroll ">
        {athletes?.map(({ firstName, lastName, position }) => (
          <div className="bg-black mt-10 h-16 rounded-xl text-white p-5">
            <section className="flex  flex-row-reverse ...">
              <div className="bg-blue-400 w-11 ml-20 rounded-2xl"></div>
              <section>
                <div>
                  <label className="text-center">{`${firstName} ${lastName}`}</label>
                </div>
